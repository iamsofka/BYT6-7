...
public class Money implements Comparable<Money> {
	...
	public String toString() {
		...
		int delimeter = amount % 100;
		return "" + money + "." + delimeter + " " + currency.getName();
	}
	...
	public Boolean equals(Money other) {
		...
		if (currency.getRate().doubleValue() != other.getCurrency().getRate().doubleValue()) {
			return false;
		}
		if (!currency.getName().equals(other.getCurrency().getName())) {
			return false;
		}
		return true;
	}
	...
	public Money add(Money other) {
		int newAmount = (int)(amount + (other.universalValue() / currency.getRate()));
	...
	public int compareTo(Money other) {
		int money1 = this.universalValue();
		int money2 = other.universalValue();
